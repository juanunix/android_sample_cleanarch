...
/**
 * This class represents the won item list fragment that shows all auction items in which the
 * logged user bought.
 * @author Felipe Porge Xavier - <a href="http://www.felipeporge.com/">www.felipeporge.com</a>
 * @since 22/11/16
 */
public class WonItemListFragment extends PresenterFragment<MainActivity, WonItemListPresenter>
        implements OnRecyclerViewItemClicked<AuctionItemModel> {

    /* ButterKnife View Injections - BEGIN */

    @BindView(R.id.won_items_recycler_view)
    RecyclerView itemListRv;

    @BindView(R.id.won_items_loading_ll)
    LinearLayout loadingLl;

    @BindView(R.id.won_items_no_items_ll)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_won_item_list, container, false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        setTitle(R.string.won_items_title);
